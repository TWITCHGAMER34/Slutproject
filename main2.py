...
def jokes(f): # get jokes from the api
    """
    ...
    :return:
    """
    data = requests.get(f) # get the data from the api
    tt = json.loads(data.text) # load the data
    return tt # return the data
...
def window():
    """
    This method is used to set up the window for the game to work properly and to be able to run the game.
    :return:
    """
...
def setup_button(input_el, callback, font_size): # set up the buttons
    ...
    button["activebackground"] = "#474747" # set the background color of the button when it is clicked
...
class Setup: # set up the game
    ...
    def __init__(self, root_el, states_el): # initialize the class
        ...
        align_str = '%dx%d+%d+%d' % (width, height, (screenwidth - width) / 2,
                                     (screenheight - height) / 2) # set the position of the window
        root_el.configure(bg="#000000") # set the background color of the window
        root_el.geometry(align_str) # set the size of the window
        root_el.resizable(width=False, height=False) # set the window to be resizable or not
        ...
        font = tk_font.Font(family='Times', size=50, weight="bold", slant="italic", underline=True) # set the font of the title
        ...
        start["activebackground"] = "#474747" # set the background color of the start button when it is clicked
        ...
        quit_el["activebackground"] = "#000000" # set the background color of the quit button when it is clicked
        quit_el["activeforeground"] = "#ffffff" # set the color of the text of the quit button when it is clicked
        ...
        jOke = setup_text(f'Joke of the day: \n {joke["setup"]} \n{joke["punchline"]}', font_size=15, f_g="white") # set the joke of the day
        jOke.place(x=0, y=400, width=1200, height=150) # set the position of the joke of the day
    ...
    def main(self):
        ...
        self.entry1.place(x=780, y=140, width=118, height=52) # set the position of the entry of the age

        self.entry2 = setup_entry() # set the entry of the name
        self.entry2.place(x=240, y=140, width=118, height=52) # set the position of the entry of the name
    ...
    def confirm_main(self): # set the confirm main method
        ...
        state2text = setup_text(f'Hello {alder}, you are {namn} years old, correct?', font_size=30, f_g="white") # set the text of the confirm main
        state2text.place(x=400, y=20, width=357, height=300) # set the position of the text of the confirm main
...
class States(Setup): # create the states class
    ...
    def state3(self): # set the state3 method, this method is used when the player is in the first room.
        """
        ...
        state3text.place(x=-250, y=10, width=1100, height=600) # set the position of the text of the first room

        state3knapp = setup_button('Open the door infront of you', self.state4, font_size=15) # set the door infront of you button
        state3knapp.place(x=500, y=200, width=300, height=50) # set the position of the door infront of you button

        state3knapp1 = setup_button('Open the door to your right', self.state5, font_size=15) # set the door to your right button
        state3knapp1.place(x=500, y=300, width=300, height=50) # set the position of the door to your right button

        state3knapp2 = setup_button('Open the door to your left', self.state6, font_size=15) # set the door to your left button
        state3knapp2.place(x=500, y=100, width=300, height=50) # set the position of the door to your left button

    def state4(self): # set the state4 method, this method is used when the player is in the second room.
        """
        ...
        state4text.place(x=-250, y=20, width=1000, height=600) # set the position of the text of the second room

        state4knapp = setup_button('Go up the stairs', self.state7, font_size=20) # set the go up the stairs button
        state4knapp.place(x=500, y=150, width=300, height=52) # set the position of the go up the stairs button

        state4knapp1 = setup_button('Go down the stairs', self.state8, font_size=20) # set the go down the stairs button
        state4knapp1.place(x=500, y=250, width=300, height=52) # set the position of the go down the stairs button

    def state5(self): # set the state5 method, this method is used when the player is in the third room.
        """
        ...
        state5text2 = setup_text("""
             ...
             anyone, will come to your rescue.""", font_size=13, f_g="white") # set the text of the third room
        state5text2.place(x=450, y=0, width=400, height=600) # set the position of the text of the third room

        state5knapp = setup_button('Fight the zombie', self.fzombie, font_size=20) # set the fight the zombie button
        state5knapp.place(x=850, y=250, width=300, height=52) # set the position of the fight the zombie button

    def state6(self): # set the state6 method, this method is used when the player is in the fourth room.
        """
        ...
        state6knapp = setup_button('Fight the zombie', self.fzombie, font_size=20) # set the fight the zombie button
        state6knapp.place(x=850, y=350, width=300, height=52) # set the position of the fight the zombie button
    ...
    def fzombie(self):  # set the fzombie method, this method is used when the player is fighting the zombie.
        """
        This method is used to set up the GUI when the player is fighting the zombie.
        :return:
        """
        fzombieval = random.randint(1, 2) # set the fzombieval variable to a random number between 1 and 2
        if fzombieval == 1: # if the fzombieval variable is equal to 1, then the player wins the fight
    ...
    def zstate2(self): # set the zstate2 method, this method is used when the player wins the fight against the zombie.
        """
        ...
        zstate2text.place(x=-250, y=20, width=1000, height=600) # set the position of the text of the fifth room

        zstate2knapp = setup_button('Go up the stairs', self.state7, font_size=20) # set the go up the stairs button
        zstate2knapp.place(x=500, y=150, width=300, height=52) # set the position of the go up the stairs button

        zstate2knapp1 = setup_button('Go down the stairs', self.state8, font_size=20) # set the go down the stairs button
        zstate2knapp1.place(x=500, y=250, width=300, height=52) # set the position of the go down the stairs button

    def state7(self): # set the state7 method, this method is used when the player is in the fifth room.
        """
        ...
        state7text.place(x=-250, y=20, width=1000, height=600) # set the position of the text of the sixth room

        state7knapp = setup_button('Go back down the stairs', self.state8, font_size=20) # set the go back down the stairs button
        state7knapp.place(x=500, y=150, width=300, height=52) # set the position of the go back down the stairs button

        state7knapp1 = setup_button('Stay, and wait', self.win, font_size=20) # set the stay and wait button
        state7knapp1.place(x=500, y=250, width=300, height=52) # set the position of the stay and wait button

    def state8(self):   # set the state8 method, this method is used when the player is in the sixth room.
        """
        ...
        state8text.place(x=-250, y=20, width=1000, height=600) # set the position of the text of the sixth room

        state8knapp = setup_button('Listen to your friend', self.state6, font_size=20) # set the listen to your friend button
        state8knapp.place(x=500, y=150, width=300, height=52) # set the position of the listen to your friend button

        state8knapp1 = setup_button('Ignore your friend', self.zdead, font_size=20) # set the ignore your friend button
        state8knapp1.place(x=500, y=250, width=300, height=52) # set the position of the ignore your friend button
    ...
    def win(self): # set the win method, this method is used when the player wins the game.
        ...
        I'm here to save you", you say "Thank you so much!""", font_size=15, f_g="white") # set the text of the win screen
        statewin.place(x=-180, y=20, width=700, height=600) # set the position of the text of the win screen

        statewin1 = setup_button('Play again', self.state3, font_size=20)
        statewin1.place(x=500, y=150, width=300, height=52) # set the position of the play again button
